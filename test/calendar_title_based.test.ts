...
describe('traerContemplacionesSemana - fechas exactas', () => {
  const casos = [
    { fecha: [2025, 6, 25], ids: [78774], nombre: 'Sagrado Corazón' },
    { fecha: [2025, 8, 17], ids: [59118], nombre: 'Asunción' },
    // Fiestas fijas (mes-día, año cualquiera)
    { fecha: [2025, 11, 2], ids: [58851], nombre: 'Todos los Santos' },
    ...
    { fecha: [2025, 12, 14], ids: [66726, 17615, 72698, 79652, 68874, 60128], nombre: 'Inmaculada Concepción' },
    { fecha: [2025, 12, 21], ids: [85000, 88395, 56283], nombre: 'Adviento 4 A' },
    { fecha: [2025, 12, 28], ids: [98245, 33270, 49797, 12905, 61208, 74938, 76284], nombre: 'Sagrada Familia' },
    // 2026
    { fecha: [2026, 1, 4], ids: [11221, 37297, 86378, 20911, 52798], nombre: '2º Domingo después de Navidad' },
